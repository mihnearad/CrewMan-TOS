...
import { entityStatusOptions } from '@/components/ui/FilterPills'
    ...
    <div>
      ...
      {filteredClients.length === 0 ? (
        <div className="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center dark:border-gray-600">
          ...
          <h3 className="mt-2 text-sm font-semibold text-gray-900 dark:text-white">No matching clients</h3>
                  ...
                  <tr key={client.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link href={`/clients/${client.id}`} className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center dark:bg-indigo-900/50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 dark:text-white">{client.contact_name || '-'}</div>
